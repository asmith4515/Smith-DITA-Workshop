...
1\. Check the sender's email address for legitimacy (See Figure 1).

2\. Hover your cursor over links without clicking on them.

3\. Search for urgency in the language used (See Figure 1).

4\. Check for generic greetings (See Figure 1).
...
The student has identified the email as a phishing email.
...
3\. Select \*\*Report Phishing\*\*. (See Figure 3).

4\. Delete the email. (See Figure 3).
...
Each goal description made sure to include new information to keep readers from skimming through and missing anything important that could harm their future encounters with phishing emails. A warning was included for the first task at the end of the "Next Steps" section to remind readers of the consequences of providing personal information to phishing emails; the warning section also included a solution in case students already acted. Lastly, screenshots were cropped depending on what was being shown at the time. For instance, figure 1 showcases the entire email with red arrows pointing at the red flags of the suspicious email to provide an example. The arrows along with the cropped photos direct the reader's attention to specific points to aid in their overall comprehension of the task being given. Overall, this procedure was a bit difficult to construct because it is a different form of writing that I must continue practicing so it can be done more effectively in the future.